...
function startCountdown(unlock){
  ...
  countdownInterval = setInterval(()=>{
    ...
    if(remaining <=0){ clearInterval(countdownInterval); result.innerHTML="El mensaje ya puede abrirse"; return; }
...
async function loadMessage(){
  ...
  if(hours <=24){
    ...
    `;
  }else{ html+="Solo puedes extender el tiempo cuando queden 24h o menos."; }
